...
LANGUAGE C IMMUTABLE STRICT;
CREATE OR REPLACE FUNCTION base36_4b_from_text(text) RETURNS base36_4b AS '$libdir/base36_4b'
LANGUAGE C IMMUTABLE STRICT;
...
CREATE CAST (text AS base36_4b) WITH FUNCTION base36_4b_from_text(text) AS ASSIGNMENT;
